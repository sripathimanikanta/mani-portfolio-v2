      ...
      <div className="footer-container">
        ...
        <div className="footer-socials">
          <a href="https://www.linkedin.com/in/manikanta-sripathi/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            {/* LinkedIn */}
            <img src={`${import.meta.env.BASE_URL}linkedin-brands-solid-full.svg`} alt="My Logo" style={{ width: '50px' ,height: '50px'}} />
          </a>
          <a href="https://www.youtube.com/@manideconstructs" target="_blank" rel="noreferrer" aria-label="YouTube">
            {/* YouTube */}
            <img src={`${import.meta.env.BASE_URL}youtube-brands-solid-full.svg`} alt="My Logo" style={{ width: '50px' ,height: '50px'}} />
          </a>
          <a href="https://x.com/msripathi035" target="_blank" rel="noreferrer" aria-label="X (Twitter)">
            {/* X */}
            <img src={`${import.meta.env.BASE_URL}twitter-brands-solid-full.svg`} alt="My Logo" style={{ width: '50px' ,height: '50px'}} />
          </a>
          <a href="https://www.instagram.com/manikda_art/" target="_blank" rel="noreferrer" aria-label="Instagram">
            {/* Instagram */}
            <img src={`${import.meta.env.BASE_URL}instagram-brands-solid-full.svg`} alt="My Logo" style={{ width: '50px' ,height: '50px'}} />
          </a>
        </div>
